...
PORT=${PORT:-18226}
SERVED_MODEL_NAME=${SERVED_MODEL_NAME:-gemma4-slake-vqa-lora-projector512}
API_KEY=${API_KEY:-EMPTY}

BASE_MODEL=${BASE_MODEL:-/data/home/mindazhao/hf_models/google_gemma-4-31B-it}
OUT_DIR=${OUT_DIR:-outputs/lora/gemma4_slake_vqa_lora_language_projector_r16_a32_lr1e-4_seed3407_max512}
ADAPTER_DIR="${OUT_DIR}/best"
MERGED_DIR="${OUT_DIR}/best_merged"
TEST_OUT_DIR="${OUT_DIR}/test_generation_vllm_merged_max512"

LOG_DIR=logs/slake_lora_projector512
...
echo "[train] SLAKE-only language+projector LoRA, lr=1e-4, eval/test max_tokens=512" | tee -a "${RUN_LOG}"
