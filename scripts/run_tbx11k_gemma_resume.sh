...
echo "[gemma_resume] started $(date)"
python3 scripts/run_final_classification.py --config configs/final/tbx11k_gemma4_noicl_fixed6_random6.yaml --methods random_icl fixed_random_6
...
echo "[gemma_resume] finished $(date)"
